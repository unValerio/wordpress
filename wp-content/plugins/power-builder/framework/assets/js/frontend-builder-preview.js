(function($){
	...
	TM_PageBuilder_Preview = function( e ) {
		...
		if ( e.origin !== tm_preview_params.preview_origin ) {
			$('.tm-pb-preview-loading').replaceWith( $('<h4 />', { 'style' : 'text-align: center;' } ).html( tm_preview_params.alert_origin_not_matched ) );
			return;
		}
	...
	window.addEventListener( 'message', TM_PageBuilder_Preview, false );
})(jQuery)