 ...
 */
do_action('mprm_before_shortcode_menu_item_list');
/**
 ...
 * @hooked mprm_menu_item_list_attributes - 50
 * @hooked mprm_menu_item_list_excerpt - 60
 * @hooked mprm_menu_item_list_price - 70
 * @hooked mprm_menu_item_list_right_footer - 75
 * @hooked mprm_menu_item_list_footer - 80
 */
do_action('mprm_shortcode_menu_item_list');
/**
 ...
 */
do_action('mprm_after_shortcode_menu_item_list');
